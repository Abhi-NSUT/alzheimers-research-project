...
for i, exp_model in enumerate(trained_expert_models):
...
try:
    ...
    plt.savefig(f"{save_dir}/1_confusion_matrix.png", bbox_inches='tight')
...
try:
    ...
    plt.savefig(f"{save_dir}/2_classification_report.png", bbox_inches='tight')
except Exception as e:
    pass
...
try:
    ...
    plt.savefig(f"{save_dir}/3_roc_curve.png", bbox_inches='tight')
except Exception as e:
    pass
...
try:
    ...
    plt.savefig(f"{save_dir}/4_pr_curve.png", bbox_inches='tight')
except Exception as e:
    pass
...
try:
    ...
    plt.savefig(f"{save_dir}/5_metrics_bar_graph.png", bbox_inches='tight')
except Exception as e:
    pass
...
try:
    ...
    plt.savefig(f"{save_dir}/6_spyder_plot.png", bbox_inches='tight')
except Exception as e:
    pass
...
try:
    ...
    plt.legend()
    plt.savefig(f"{save_dir}/7_confidence_distribution.png", bbox_inches='tight')
except Exception as e:
    pass
...
try:
    ...
    plt.savefig(f"{save_dir}/8_ensemble_agreement.png", bbox_inches='tight')
except Exception as e:
    pass
...
try:
    ...
    plt.savefig(f"{save_dir}/9_image_grid_predictions.png", bbox_inches='tight')
except Exception as e:
    pass
...
try:
    ...
    plt.tight_layout()
    plt.savefig(f"{save_dir}/10_learning_curves.png", bbox_inches='tight')
except Exception as e:
    pass

print(f"\nALL 10 VISUALIZATION GRAPHS HAVE BEEN COMPILED AND SAVED INSIDE {save_dir}/")
